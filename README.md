...
| 📞 **Contracts** | Theme-aware карта NightCity.io v0.04.1 с markers для district/subdistrict, Badlands sectors и Orbital Air Space Center; optional covers, Persona-роли, public/classified briefing, rewards, мгновенная запись, waitlist, исторический Crew и Aftermath. |
