...
Правила работы с листом: пишем только в белые поля; строки и столбцы внутри блоков не удалять и не вставлять — формулы считают фиксированные диапазоны, а свободные строки уже заложены (оружие 3–8, броня 4–6, инвентарь № 20, зависимости/цели/табу на 06, лог дел 06). В игре: текущие HP — 02, патроны и добро — 05, крит-травмы, зависимости, IP и лог дел — 06.
