...
class AccessRoleMigrationTests(unittest.TestCase):
    ...
    def test_legacy_roles_migrate_idempotently_with_backup(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(
                ...
                server.MIGRATION_FEED_SINGLE_FORMAT)
    ...
    def test_frontend_has_no_self_assign_gm_controls(self):
        ...
        self.assertIn('nc-contract-cover-frame', network)
        self.assertIn('nc-contract-detail-cover', network)
        self.assertIn('.nc-contract-cover{display:block', network_css)
